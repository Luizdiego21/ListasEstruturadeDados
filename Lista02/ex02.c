/*2. PRÁTICA VETORES - Crie uma aplicação que seja responsável por realizar diferentes análises de até 100 médias finais de alunos de uma turma, esta aplicação deverá conter as seguintes operações:
